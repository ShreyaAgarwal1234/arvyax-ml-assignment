"""
Parse raw PDF-extracted text into clean CSVs for train and test sets.
Run once to generate: train_data.csv, test_data.csv
"""
import pandas as pd
import numpy as np
import re, io
...
# ── TRAINING DATA ────────────────────────────────────────────────────────────
# Columns: id, journal_text, ambience_type, duration_min, sleep_hours,
#          energy_level, stress_level, time_of_day, previous_day_mood,
#          face_emotion_hint, reflection_quality, emotional_state, intensity

TRAIN_ROWS = """1|The ocean ambience helped me stop drifting and concentrate on my next steps. My to-do list feels less chaotic.|ocean|12|6.5|4|2|afternoon|mixed|calm_face|clear|focused|3
...
38|I wanted the mountain to calm me, but today my stress feels bigger than the session. I feel emotionally tired.|mountain|10|5|1|5|early_morning|||conflicted|overwhelmed|5
...
92|The forest track was fine I feel steady, not especially better or worse At least I paused for a moment|forest|15|5.5|2|3|morning|overwhelmed|neutral_face|vague|neutral|1
...
rows = []
for line in TRAIN_ROWS.strip().split('\n'):
    parts = line.split('|')
    rows.append(parts)
